                            ...
                            <div class="span12" id="divCadastrarOs">
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    ...
                                    <div class="span3" >
                                        ...
                                        <input name="descricaoProduto" class="span12"  type="text"  id="descricaoProduto" value="<?php echo $result->descricaoProduto ?>" onChange="javascript:this.value=this.value.toUpperCase();" />
                                        
                                    </div>

                                    <div class="span2" >
                                        <label for="marcaProdutoOs">MARCA </label>
                                        <input name="marcaProdutoOs" class="span12"  type="text"  id="marcaProdutoOs" value="<?php echo $result->marcaProdutoOs ?>" onChange="javascript:this.value=this.value.toUpperCase();" />
                                        
                                    </div>

                                    <div class="span2" >
                                        <label for="modeloProdutoOs">MODELO</label>
                                        <input name="modeloProdutoOs" class="span12"  type="text"  id="modeloProdutoOs" value="<?php echo $result->modeloProdutoOs ?>" onChange="javascript:this.value=this.value.toUpperCase();" />
                                        
                                    </div>

                                    <div class="span2" >
                                        <label for="nsProdutoOs">NÚMERO DE SÉRIE</label>
                                        <input name="nsProdutoOs" class="span12"  type="text"  id="nsProdutoOs" value="<?php echo $result->nsProdutoOs ?>" onChange="javascript:this.value=this.value.toUpperCase();" />
                                        
                                    </div>

                                    <div class="span3" >
                                        <label for="ucProdutoOs">UNIDADE CONSUMIDORA</label>
                                        <input name="ucProdutoOs" class="span12"  type="text"  id="ucProdutoOs" value="<?php echo $result->ucProdutoOs ?>" onChange="javascript:this.value=this.value.toUpperCase();" />
                                    ...
                                    <div class="span6" >
                                        ...
                                        <input name="defeito" class="span12"  type="text"  id="defeito" value="<?php echo $result->defeito ?>" />
                                        
                                    </div>

                                    <div class="span6" >
                                        <label for="analiseBasica">Defeito constatado em análise básica</label>
                                        <input name="analiseBasica" class="span12"  type="text"  id="analiseBasica" value="<?php echo $result->analiseBasica ?>" />
